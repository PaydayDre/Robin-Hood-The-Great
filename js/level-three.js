...
function startGame(){
    ...
    try{
       ...
       // endSound.play().catch(function(e){})
        ...
        //highScoreSound.play().catch(function(e){}); just for testing
        runCount++;
        }
    }catch(err){}
...
startSound.src = " ";
startSound.volume = 0.025;
        
var shootSound = new Audio();
shootSound.src = "media/sounds/Cartoon_Arrow_Sound_Effect.mp3";
        
var hitSound = new Audio();
hitSound.src = "media/sounds/hit.mp3";
        
var bgSound = new Audio();
bgSound.src = "media/sounds/Robin_Hood_whistle_stop.mp3";
bgSound.loop = true;
bgSound.volume = 0.025;
        
var endSound = new Audio();
endSound.src = "media/sounds/sad-game-over-trombone.wav";
endSound.volume = 0.6;
        
var successSound = new Audio();
successSound.src = "media/sounds/success.mp3";
        
var highScoreSound = new Audio();
highScoreSound.src = "media/sounds/success.mp3";
...
//animate the score being displayed on screen
    ...
    var ctx = c.getContext("2d"); //create 2d animation
    ...
    var boardY;
    var boardMove = false;	//tell the game when to move the board up and down like the bow and arrow
    var totalArr = 3; //total amount of arrows
    updArr(totalArr);

//board that catches arrow drawing
    function drawBoard() {
        ctx.beginPath();
...
//functions to control arrow and arrow movement
    function Arrow(){
        this.w = 85;
        this.x = arc.x-25;
        this.dx = 20;
                    ...
                    if(this.x < w-155){
                        ...
                        if(!(this.fy <= board.y-board.height/2 || this.fy >= board.y+board.height/2) || this.x > w){
                            if(this.x > w-110){
                                ...
                                else if(score === 8){ //if player has a score of 8 allow the board to move automatically
                                    autoMove = true;
                                }
...
//create the drawing of the bow illusion
    function drawRope() {
        ctx.beginPath();
...
//press any button to shoot or click to shoot arrows
